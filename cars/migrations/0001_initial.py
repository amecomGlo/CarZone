    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('photo_2', models.ImageField(blank=True, null=True, upload_to='photo/%Y/%m/%d')),
                ('photo_3', models.ImageField(blank=True, null=True, upload_to='photo/%Y/%m/%d')),
                ('photo_4', models.ImageField(blank=True, null=True, upload_to='photo/%Y/%m/%d')),
                ('photo_5', models.ImageField(blank=True, null=True, upload_to='photo/%Y/%m/%d')),
